module Content.ThePromisedLand exposing (content)
...
body =
    ...
    TODO: We don't need to do this. I believe any text is
    parsable as valid Markdown. So, we can just store the md
    files in an Elm file. This can be super simple. Though...
    I must admit, having the ability to just share the Markdown
    file is sorta cool. We should consider both options here.
